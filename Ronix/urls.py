"""
URL configuration for Ronix project.
...
schema_view = get_schema_view(
   openapi.Info(
      title="Ronix API",
      default_version='v1',
      description="Ronix public va protected APIlar",
   ),
   public=True,
...
urlpatterns = [
    ...
    path('', include('stats.api')),
    path('', include('cart.api')),
    path('payment/', include('payment.api')),
